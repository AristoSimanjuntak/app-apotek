                            ...
                            <div class="row mb-1">
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-3">
                                            <input type="number" name="harga" id="harga" class="form-control stock" value="" required>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <div class="col-md-3">
                                    ...
                                    <table class="table table-striped table-bordered sticky-header">
                                        ...
                                        <tbody id="dtable">
                                            <?php foreach ($dtobat as $obat) { ?>
                                                <tr>
                                                    <!-- Pastikan ID berada dalam input tersembunyi -->
                                                    ...
                                                    <td>
                                                        <select name="supplier[]" class="form-control supplier" style="text-align:center;" disabled>
                                                    ...
                                                    <td><input type="text" name="harga[]" class="form-control harga" style="text-align: center;" value="<?= $obat->harga ?>" readonly /></td>
                                                    <td><input type="text" name="updated_by[]" class="form-control updated_by" style="text-align: center;" value="<?= $dtpersonil ?>" readonly /></td>

                                                    <!-- ID tersembunyi untuk referensi saat update 
                                                    <input type="hidden" class="id" value="<?= $obat->id ?>" />-->

                                                    <td>
                                                        <button type="button" class="btn bg-gradient-info edit_buttonn" disabled>Edit</button>
                                            ...
                                            if (!isset($dtobat)) { ?>
                                                ...
                                                <tr>
                                                    <td valign="top"><input name="chk[]" type="checkbox" class="chk" />
                                                        <input type="hidden" name="id[]" class="id" value="<?= htmlspecialchars($dtobat_row->id); ?>" />
                                                    </td>
                                                    <td> <input type="text" name="nama_obat[]" id="nama_obat" class="form-control nama_obat" style="text-align: center;" value="<?= $dtobat_row->nama_obat;  ?>" readonly></td>
                                                     <td>
                                                        <input type="text" name="supplier[]" class="form-control supplier" style="text-align: center;" value="<?= htmlspecialchars($dtobat_row->namasupplier); ?>" />
                                                    </td> 
                                                    <td>
                                                        <select name="updated_by[]" id="updated_by" class="hitung_spec form-control updated_by" style="text-align:center;">
                                                            <?php foreach ($suppliers as $supplier) { ?>
                                                                <option value="<?= $dtobat_row->namasupplier ?>"readonly
                                                                    <?= $supplier->id == $dtobat_row->namasupplier ? 'selected' : ''; ?>>
                                                                    <?= htmlspecialchars($supplier->namasupplier); ?> 
                                                                </option>
                                                            <?php } ?>
                                                        </select>
                                                    </td>
                                                    ...
                                                    <td> <input type="text" name="harga[]" id="harga" class="form-control harga" style="text-align: center;" value="<?= $dtobat_row->harga;  ?>" readonly></td>
                                                     ...
                                                     <td>
                                                        <input type="text" name="updated_by[]" class="form-control updated_by" style="text-align: center;" value="<?= htmlspecialchars($dtpersonil); ?>" />
                                                    </td>
                                                    <td>
...
<script>
    ...
    $(document).on('click', '.delete_button', function() {
        ...
        if (id != 'undefined') {
            ...
            if (confirmation) {
                $.ajax({
                    url: "<?=  base_url(); ?>index.php/master/C_obat/delete",
                    type: "POST",
